...
public class Base64 {
	...
	public static void main(String[] args) {
		String s = "5CC9D9B48EFCF2FDB766BFB00E08EEDF5CC9D9B48EFCF2FDB766BFB00E08EEDF5CC9D9B48EFCF2FDB766BFB00E08EEDF5CC9D9B48EFCF2FDB766BFB00E08EEDF5CC9D9B48EFCF2FDB766BFB00E08EEDF";
		System.err.println(s);
		System.out.println();
		System.out.println(Base64.encode(s.getBytes(StandardCharsets.UTF_8)));
		
		System.err.println(
				new String(
				Base64.decode(Base64.encode(s.getBytes(StandardCharsets.UTF_8))))
				);
	}
