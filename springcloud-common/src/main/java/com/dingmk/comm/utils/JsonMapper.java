...
public class JsonMapper {
    ...
    public final static JsonMapper DEFAULT_JM = nonDefaultMapper();

    public final static JsonMapper NON_EMPTY_JM = nonEmptyMapper();

    public final static JsonMapper NON_NULL_JM = nonNullMapper();
